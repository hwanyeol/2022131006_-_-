...
from chapter2.주소 import Address
...
class AddressBook:
    ...
    def on_click_lb(self, event=None):
        # 리스트박스의 항목을 클릭했을 때 데이터를 설정
        self.set_data()

    def set_data(self):
        # 선택된 주소의 데이터를 입력 필드에 설정
